...
# Add Node Registration Script to Worker Node VM image
cat <<EOF > registerNode.sh
#!/bin/bash -x
...
sudo chmod 755 registerNode.sh
sudo chown $VM_USER:$VM_USER registerNode.sh
sudo mv registerNode.sh $KUBEDIR
