...
$CHECKSUM=(get-filehash -Algorithm SHA512 "../../../boxes/${OUTPUT_DIR}-${VM_VERSION}/${VM_NAME}-${VM_VERSION}.box").Hash
...
if ( Test-Path -Path "..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json" -PathType Leaf )
{
    if ( Test-Path -Path "..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json.previous" -PathType Leaf )
    {
        Remove-Item -Force "..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json.previous"
    }
    Rename-Item -Force "..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json" -NewName "${VM_NAME}-${VM_VERSION}_metadata.json.previous"
}
...
(Get-Content ..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json).replace("##URL##", "base-vm/boxes/${OUTPUT_DIR}-${VM_VERSION}/${VM_NAME}-${VM_VERSION}.box") | Set-Content ..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json
(Get-Content ..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json).replace("##CHECKSUM##", "${CHECKSUM}") | Set-Content ..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json
