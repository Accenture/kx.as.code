...
(Get-Content ..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json).replace("##NAME##", "${PACKER_BUILD_NAME}") | Set-Content ..\..\..\boxes\${OUTPUT_DIR}-${VM_VERSION}\${VM_NAME}-${VM_VERSION}_metadata.json
