...
try {
    ...
    println(profile_template_paths)
...
try {
    ...
    <head>
        <script>
            function getTemplates() {
                ...
                console.log("templateDefinitionsArray: " + templateDefinitionsArray);
            ...
            function getTemplateComponents(templateId) {
                ...
                if ( templateId === -1  || templateId === null || templateId === '' ) {
                    ...
                    templateComponentsArray = document.getElementById('template-components-array').value;
                    console.log(templateComponentsArray);
            ...
            function selectTemplatesAlreadyExistingInProfile(existingTemplates) {
                console.log("Received following templates already in profile: " + existingTemplates);
                templateRows = existingTemplates.split(",");
                for (let template of templateRows) {
                    console.log("Unsplit template: " + template);
                    let selectedTemplate = template;
                    console.log("Adding already existing template in profile: " + selectedTemplate);
                    addTemplateToProfile(selectedTemplate);
                }                   
            }

            function addTemplateToProfile(selectedTemplate) {
                console.log("Entered addTemplateToProfile(selectedTemplate) --> " + selectedTemplate);
                if(selectedTemplate) {
                   console.log("Adding template passed through function call --> " + selectedTemplate);  
                } else {
                    selectedTemplate = document.getElementById("templates").value;
                    console.log("Adding template from document as not passed though function call --> " + selectedTemplate);                
                }
    ...
    Profile template paths: ${existingTemplatesInSelectedProfile}<br>
    templateDefinitionsArray: ${templateDefinitionsArray}<br>
    """
    return HTML
} catch (e) {
