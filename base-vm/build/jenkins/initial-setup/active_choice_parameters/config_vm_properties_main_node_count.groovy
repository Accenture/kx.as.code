...
def rangeUnit = "#"
def warningText = ""
def infoText = "Determines the number of KX-Main nodes that will be started"
def paramIcon = "/userContent/icons/pound.svg"
def paramShortTitle = "Number KX-Main Nodes"
def variablesSuffix = "main_node_count"
...
try {
    if (STANDALONE_MODE != true) {
        ...
        max = 16
        step = 1
        startValue = main_node_count.toInteger()
...
try {
    ...
    <div class="outerWrapper" id="main-node-count-div" style="display: block;">
        <div class="wrapper"><span><img src="${paramIcon}" class="param-icon svg-purple" alt="#" /></span>
            ...
            <span class="button-range-span">
                    <span class="divider-span"></span>
                    <button type="button" class="button-right" style="opacity: ${opacity}; cursor: ${cursor}"
    ...
    println "Something went wrong in the HTML return block (config_vm_properties_main_node_count): ${e}"
}
