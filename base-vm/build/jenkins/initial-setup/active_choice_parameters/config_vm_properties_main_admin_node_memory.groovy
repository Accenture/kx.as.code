...
int max = 32384
int step = 1024
int startValue = main_admin_node_memory.toInteger()
int minWarning = 8192
int valueDisplayConversion = 1024 // Set to 1 for no conversion. Option for display MB as shorter GB form
def rangeUnit = "GB"
def warningText = "Warning. Allocating less than 8GB of ram to the admin main node may result in a poor experience"
def infoText = "Determines the amount of memory that will be allocated to the KX-Main Admin VM"
def paramIcon = "/userContent/icons/memory-solid.svg"
def paramShortTitle = "Memory"
def variablesSuffix = "main_admin_node_memory"
...
try {
    ...
    def HTML = """
    <body>
    <div class="outerWrapper" id="main-memory-div" style="display: block">
    ...
    println "Something went wrong in the HTML return block (config_vm_properties_main_admin_node_memory): ${e}"
}
