    ...
    if (props.isMqConnected) { // TODO: Disable in API Mock Mode
      if (props.getQueueStatusList(props.appName) == "pending_queue") {
        return (
          <div className="flex">
            <button 
              className="bg-ghBlack4 p-2 px-5 items-center flex"
              disabled
            >
              <svg
            ...
            <Tooltip title={`Re-install ${props.appName}`} placement="top" arrow>
              <button className="bg-kxBlue p-2 ml-1" disabled>
                <RestartAltIcon
                  aria-label="list"
                  color="white"
                  onClick={() => {
        ...
        return (
          <button
            className="bg-red-500 p-2 px-5 items-center flex"
            to="#0"
            onClick={() => {
        ...
        return (
          <div className="flex">
            ...
            <Tooltip title={`Re-install ${props.appName}`} placement="top" arrow>
              <button className="bg-kxBlue2 p-2 ml-1" disabled>
                <RestartAltIcon
                  aria-label="list"
                  color="white"
                  onClick={() => {
      ...
      return (
        ...
        <button disabled
          className="border-statusRed border p-2 px-5 items-center flex text-statusRed"
          to="#0"
          onClick={() => {
            props.applicationInstallHandler();
          }}
