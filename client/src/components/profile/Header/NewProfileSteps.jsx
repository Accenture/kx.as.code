  ...
  return (
      <Box id="new-prof-gen-steps-container">
        ...
        >
          ...
          <Box className="step3">
            {currentView===UIView.Storage &&<Box id="current-step3"></Box>}
          </Box>
          <Box className="step4">
            {currentView===UIView.Optional &&<Box id="current-step4"></Box>}
          </Box>
          <Box className="step5">
            {((currentView===UIView.Review) || (currentView===UIView.ReviewA) || (currentView===UIView.Installation)) &&<Box id="current-step5"></Box>}
          </Box>
        </Box>
        <Box
