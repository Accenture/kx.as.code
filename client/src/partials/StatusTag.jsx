...
export default function StatusTag(props) {
    ...
    console.log(getTagBgColor(props.installStatus))

    return (
        <div className={ "text-white bg-opacity-70 rounded-xl p-1 px-3 text-xs flex m-auto ml-2 " + getTagBgColor(props.installStatus) } >
