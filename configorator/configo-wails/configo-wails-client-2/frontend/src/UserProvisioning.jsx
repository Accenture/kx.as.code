        ...
        <div className='text-left'>
            <div className='relative'>
                ...
                <div className='dark:bg-ghBlack4'>
                    <ConfigSectionHeader sectionTitle={"User Groups"} SectionDescription={"More Details about this section here."} setActiveConfigTab={setActiveConfigTab} activeConfigTab={activeConfigTab} contentName={"User Groups"}/>
                </div>
            </div>
