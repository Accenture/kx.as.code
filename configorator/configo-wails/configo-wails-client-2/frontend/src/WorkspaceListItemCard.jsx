...
export function WorkspaceListItemCard({ index, itemData, selectedItem, handleItemClick, handleDeleteItem, handleDublicateItem }) {
            ...
            <div ref={parentRef} className="col-span-12 flex items-center relative">
                <div className='flex items-center'>
                    ...
                    <div className="text-left">
                        <div className='whitespace-nowrap w-[190px] overflow-hidden text-ellipsis'>{itemData.name !== "" ? itemData.name : "No Title"}</div>
