                            ...
                            applicationGroupDetailTab == "config-ui" ? (
                                <div className='px-3'>
                                    ...
                                    <div className="pt-3">
                                        ...
                                        <InputField inputType={"input"} type={"text"} value={data2[selectedItem].name} placeholder={'Add an application name'} handleInputChange={handleInputChange} dataKey={"name"} label={"Application Name"} />

                                        <InputField inputType={"textarea"} type={"text"} value={data2[selectedItem].Description} placeholder={'Add an application description'} handleInputChange={handleInputChange} dataKey={"Description"} label={"Application Description"} />
