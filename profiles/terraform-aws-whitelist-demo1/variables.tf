locals {
  ...
  admin_main_node_ami_id              = local.raw_data.vm_properties.main_node_ami_id
  admin_main_node_instance_type       = local.raw_data.vm_properties.main_node_instance_type
  replica_main_node_instance_type     = local.raw_data.vm_properties.main_node_instance_type
  main_node_count                     = local.raw_data.vm_properties.main_node_count

  supplemental_node_ami_id            = local.raw_data.vm_properties.supplemental_node_ami_id
