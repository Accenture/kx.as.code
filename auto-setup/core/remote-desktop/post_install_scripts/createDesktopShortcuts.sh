...
Exec=/usr/bin/chromium %U https://remote-desktop.${baseDomain}:8043 --use-gl=angle --password-store=basic
StartupNotify=true
Terminal=false
Icon=${iconPath}
Type=Application
...
Exec=/usr/bin/chromium %U https://pgadmin.${baseDomain}:7043 --use-gl=angle --password-store=basic
StartupNotify=true
Terminal=false
Icon=${iconPath}
Type=Application
