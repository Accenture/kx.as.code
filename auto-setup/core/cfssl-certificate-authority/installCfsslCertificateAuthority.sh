...
EOF
    ...
    cat ${certificatesWorkspace}/kx_server.pem ${certificatesWorkspace}/kx_intermediate_ca.pem ${certificatesWorkspace}/kx_root_ca.pem > ${certificatesWorkspace}/kx_chain_bundle.pem
